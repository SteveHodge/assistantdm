	...
	DrawingOptionsPanel(MapElement parent, DisplayManager r) {
		...
		colorPanel.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				Color newColor = JColorChooser.showDialog(DrawingOptionsPanel.this, "Choose colour", colorPanel.getBackground());	// FIXME need to create and reuse a dialog so recent colours work
				if (newColor != null) {
